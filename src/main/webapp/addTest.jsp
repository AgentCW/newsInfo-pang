...
<form id="mainForm" method="post" action="${basePath}/news_info/add" enctype="multipart/form-data">
    <input type="hidden" id="message" value="${pageCode.msg}"/>
    <div class="right">
        <div class="current">当前位置：<a href="###">内容管理</a> &gt; 新闻管理</div>
        <div class="rightCont">
            <p class="g_title fix">新增新闻</p>
            <table class="tab1" width="100%">
                <tbody>
                <tr>
                    <td align="right" width="15%">标题<font color="red">*</font>：</td>
                    <td width="30%">
                        <input name="title" value="${news.title}" class="allInput" style="width:100%;" type="text"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="30%">
                        <select name="city">
                            <c:forEach items="${cityList}" var="item">
                                <c:if test="${item.code == news.city}">selected="selected"</c:if>
                ...
                <tr>
                    ...
                    <td width="30%" colspan="3">
                        <textarea name="desc" rows="20" style="width:100%;">${modifyObj.desc}</textarea>
                    </td>
                </tr>
                </tbody>
            </table>
